...
<body>
    ...
    <div class="container">
        ...
        <form action="msg_logica_inserido.php" method="post" style="margin-top: 20px">


        <h3 style="text-align:center; margin-top:40px;">Formulário de Cadastro para Lista de Telefone</h3>

                <div class="form-group">
                    <label>Insira seu Nome</label>
                    <input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o seu nome aqui! "  required>
                </div>
                
                <div class="form-group">
                    <label>Insira sua Data de Nascimento</label>
                    <input type="date" class="form-control" name="data" id="data_de_nascimento"   required>
                </div>
